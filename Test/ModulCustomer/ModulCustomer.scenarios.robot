...
Verify Send Password Customer dengan Email Valid (Happy Path)
   [documentation]  TC-SP-001
   Sleep    3s
   Go To    ${BASE_URL}master-data/customers
   ...
   Sleep   1s
*** Test Cases ***
Verify E2E Edit Customer - Happy Path (Tab Customer & Tab Bank)
    [documentation]  TC-ED-001
    Sleep    3s
    Go To    ${BASE_URL}master-data/customers
